      ...
      <div className="row">
        <div className="col col-sm-8 offset-sm-2 d-column justify-content-center border-30 border-dark-tr text-center p-4 bg-success">
          ...
          <div className="col col-sm-8 offset-sm-2 d-column justify-content-center border-30 border-dark-tr text-center p-4 mt-4">
            <h3><strong>Can I customize the dashboard or layout of the app?</strong></h3>
            <p>
            Currently, the app does not support customizing the dashboard or layout. However, we welcome feedback and may consider adding this feature in future updates.
            </p>
          </div>
          <div className="col col-sm-8 offset-sm-2 d-column justify-content-center border-30 border-dark-tr text-center p-4 mt-4 bg-success">
            ...
            <p>
            Yes, we provide tutorials and guides within the app to help users familiarize themselves with its features and functionalities. You can access these resources in the "Help" or "FAQ" section.
            </p>
        </div>
      </div>
    </>
